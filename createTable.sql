...
AS
	SELECT secret.employeeid as employeeid, TO_CHAR(birthday,'	') as birthday,
...
INSERT INTO employee_secret VALUES(1000,'2000-12-23','テスト問題','テスト回答');
INSERT INTO employee_secret VALUES(1001,'2000-12-23','テスト問題','テスト回答');
INSERT INTO employee_secret VALUES(1002,'2000-12-23','テスト問題','テスト回答');
INSERT INTO employee_secret VALUES(1003,'2000-12-23','テスト問題','テスト回答');
INSERT INTO employee_secret VALUES(1004,'2000-12-23','テスト問題','テスト回答');
INSERT INTO employee_secret VALUES(1005,'2000-12-23','テスト問題','テスト回答');
INSERT INTO employee_secret VALUES(1006,'2000-12-23','テスト問題','テスト回答');
...
UPDATE time_sheets SET attendance = TO_DATE('10:00','HH24:MI') WHERE employeeid = 1006 AND work_day = TO_DATE('20201203','RRRR-MM-DD');